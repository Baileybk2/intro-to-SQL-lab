...
-- Write SQL query here
-- find Vatican City country
-- return language 

SELECT countrylanguages.language FROM countrylanguages WHERE countrycode = 'VAT';
--  language 
-- ----------
--  Italian
-- (1 row)
...
JOIN countrylanguages ON countries.code = countrylanguages.countrycode WHERE countrylanguages.language = 'Italian' AND countrylanguages.percentage = 100.0;
...
WHERE cities.name LIKE 'Serra%' AND cities.name <> 'Serravalle' AND countries.continent = 'South America';
...
SELECT cities.name AS capital_city FROM cities
